...
pub fn init_shapes(
    ...
    shaders.add(Shader::from_glsl(
        ShaderStage::Vertex,
        include_str!("../../logic/assets/shaders/shape.vert"),
    ));
    ...
    shaders.add(Shader::from_glsl(
        ShaderStage::Fragment,
        include_str!("../../logic/assets/shaders/circle.frag"),
    ));
    #[cfg(target_arch = "wasm32")]
    ...
    = shaders.add(Shader::from_glsl(
        ShaderStage::Fragment,
        include_str!("../../logic/assets/shaders/triangle.frag"),
    ));
    ...
    commands.insert_resource(ShapeMeshes {
        quad2x2: m,
        pipeline_circle: pipeline_circle_handle.clone(),
